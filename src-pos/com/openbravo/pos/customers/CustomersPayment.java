...
public class CustomersPayment extends javax.swing.JPanel implements JPanelView, BeanFactoryApp {
    ...
    private void btnCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCustomerActionPerformed
        ...
        JCustomerFinder finder = JCustomerFinder.getCustomerFinder(this, dlcustomers, app.getInventoryLocation());
        finder.search(null);
    ...
    private void btnPayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPayActionPerformed
        ...
        if (paymentdialog.showDialog(customerext.getCurdebt(), null)) {
            ...
            if(JOptionPane.showConfirmDialog(this, "Esta seguro de realizar este pago?")==JOptionPane.YES_OPTION)
            {
                ...
                ticket.setProperty("sucursal", app.getInventoryLocation());
                try {
                ...
                JOptionPane.showMessageDialog(this, "Movimiento cancelado.");
        }

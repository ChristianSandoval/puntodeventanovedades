...
public class TicketLineInfo implements SerializableWrite, SerializableRead, Serializable {
    ...
    public TicketLineInfo(String productid, double dMultiply, double dPrice, TaxInfo tax, Properties props) {
        init(productid, null, dMultiply, dPrice, tax, props, 0,0,0);
    }

    public TicketLineInfo(String productid, double dMultiply, double dPrice, TaxInfo tax) {
        init(productid, null, dMultiply, dPrice, tax, new Properties(), 0,0,0);
    }
    ...
    public TicketLineInfo(String productname, String producttaxcategory, double dMultiply, double dPrice, TaxInfo tax) {
        ...
        props.setProperty("product.name", productname);
        props.setProperty("product.taxcategoryid", producttaxcategory);
        init(null, null, dMultiply, dPrice, tax, props, 0,0,0);
    }

    public TicketLineInfo() {
        init(null, null, 0.0, 0.0, null, new Properties(), 0,0,0);
    }
    ...
    public TicketLineInfo(ProductInfoExt product, double dMultiply, double dPrice, TaxInfo tax, Properties attributes) {
        ...
        init(pid, null, dMultiply, dPrice, tax, attributes, 0,0,0);
    }
    ...
    public TicketLineInfo(TicketLineInfo line) {
        init(line.productid, line.attsetinstid, line.multiply, line.price, line.tax, (Properties) line.attributes.clone(), line.listaPrecio, line.presentacion, line.unidades);
    }

    private void init(String productid, String attsetinstid, double dMultiply, double dPrice, TaxInfo tax, Properties attributes, int listaPrecio, int presentacion, int unidades) {
    ...
    public void setListaPrecio (int lista)
    {
        listaPrecio=lista;
    }
    ...
    public void writeValues(DataWrite dp) throws BasicException {
        ...
        dp.setDouble(9, getSubValue());
        dp.setInt(10, listaPrecio);
        dp.setInt(11, presentacion);
        dp.setInt(12, unidades);
    }
    ...
    public void readValues(DataRead dr) throws BasicException {
        ...
        dr.getDouble(5);
        listaPrecio = dr.getInt(17);
        presentacion = dr.getInt(18);
        unidades = dr.getInt(19);
        System.out.println(listaPrecio+","+presentacion+","+unidades);
    }

...
public class JTicketsFinder extends javax.swing.JDialog implements EditorCreator {
    ...
    private void init(DataLogicSales dlSales, DataLogicCustomers dlCustomers, String location) {
        ...
        lpr = new ListProviderCreator(dlSales.getTicketsList(this.location), this);
...
private void btnCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCustomerActionPerformed
        JCustomerFinder finder = JCustomerFinder.getCustomerFinder(this, dlCustomers, this.location);
        finder.search(null);
